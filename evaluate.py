...
def reward_gaps(model_path, rlhf_model_path, cost_model_path, dataset_path):
    ...
    print(f"< Calculated σ(r_A(x, y) - r_A(x, z)) for {len(model_single_gap_test)} test samples >")
...
if __name__ == "__main__":
    ...
    assert os.path.isfile(args.dataset_path), "dataset file doesnt exist"

    reward_gaps(args.model_path, args.rlhf_model_path, args.cost_model_path, args.dataset_path)
    print("< Finished! >")
